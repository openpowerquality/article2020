...
\highlight{{\em 1. We need more renewable energy.}}
%%%Is italics necessary? NO. YOU CAN REMOVE THEM.
...
Userland applications communicate with the kernel driver using a file descriptor, where every \highlight{$read$}
%%%Is italics necessary here? NO, YOU CAN REMOVE THEM.
...
\highlight{{\em Bandwidth usage is minimized.}}
%%% Is italics necessary? NO, YOU CAN REMOVE THEM.
...
\highlight{{\em Makai Event Actor.}}
%%% Please confirm if this is necessary. YOU CAN REMOVE ITALICS.
...
\authorcontributions{
Conceptualization, P.M.J., A.J.C., S.N.; methodology, P.M.J., A.J.C., S.N.; software, P.M.J., A.J.C., S.N.; validation, P.M.J., A.J.C., S.N.; formal analysis, P.M.J., A.J.C., S.N.; investigation, P.M.J., A.J.C., S.N.; resources, P.M.J.; data curation, A.J.C., S.N.; writing--original draft preparation, P.M.J., A.J.C., S.N.; writing--review and editing, P.M.J., A.J.C., S.N.; visualization, P.M.J., A.J.C., S.N.; supervision, P.M.J.; project administration, P.M.J.; funding acquisition, P.M.J. All authors have read and agreed to the published version of the manuscript.
}
...
\newblock {\em Utility Dive}, {September 29, 2014}.
...
{Networks}}. In {Proceedings of the } CIGRE, Paris, France, May 15, 2018.
...
{Failures}?
\newblock {\em Electrical Construction and Maintenance Magazine}, {November 1, 2008}.
...
%%% Please confirm whether this is a book. Please add published if it is the case.
...
%%% Please add the link and the publisher.
