...
Figure \ref{fig:level-statistics} provides some descriptive statistics on the number of entities created at each level of the OPQ Information Architecture.
...
Figure \ref{fig:data-management-graph} shows a graph of storage requirements both with and without TTL-based data removal.
