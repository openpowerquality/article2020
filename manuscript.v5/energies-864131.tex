...
\Title{%The paper was slightly modified by our English editor, please check the whole text and confirm if your meaning is retained; 2.	Do not delete any comment we left for you and reply to each comment so that we can understand your meaning clearly; 3.	If you need to revise somewhere in your paper, please highlight the revisions to let us know. (Thank you for your cooperation in advance.)
\highlight{Design}, Implementation, and Evaluation of Open Power Quality}

% Authors, for the paper (add full first names)
\Author{\hl{Anthony} %Please carefully check the accuracy of names and affiliations. 
...
%%% We added a space between 5 and V. Please confirm.
...
%%% Should it be reference citation? 
...
\caption{\hl{Storage} requirements with and without~time-to-live (TTL).} %%% It seems that the figure isn't complete, please modify.
...
\newblock {\em Utility Dive}, {\hl{2014}}.%% Please add day month. 
...
\newblock In {Proceedings of the } 2017 {IEEE} {International} {Conference} on IEEE Industrial and {Information} {Systems} ({ICIIS}),  \hl{2017}; pp. 1--6, doi:10.1109/ICIINFS.2017.8300335.%% Please add conference location and date. 
...
{Networks}}. In {Proceedings of the } CIGRE, \hl{2018}.
...
{Failures}?
\newblock {\em Electrical Construction and Maintenance Magazine}, {\hl{2008}}.
...
{Monitoring} {Electric} {Power} {Quality}}; \hl{2018}. %% Please provide publisher and its location. 
